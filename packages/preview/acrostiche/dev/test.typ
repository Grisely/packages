...
#print-index(title: "Alternative index (clickeable deactivated)", alternative-style: true, highlight: true, clickable: false)
...
#print-index(title: "Alternative index Sorted up", sorted: "up", alternative-style: true, highlight: true)
#print-index(title: "Alternative index Sorted down", sorted: "down", alternative-style: true, highlight: true)
